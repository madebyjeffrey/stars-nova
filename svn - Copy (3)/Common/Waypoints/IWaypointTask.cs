...
namespace Nova.Common.Waypoints
{
    ...
    public interface IWaypointTask
    {
        ...
        bool IsValid(Fleet fleet, Item target, EmpireData sender, EmpireData receiver , out Message messageOut);
        ...
        bool Perform(Fleet fleet, Item target, EmpireData sender, EmpireData receiver , out Message messageOut);   
